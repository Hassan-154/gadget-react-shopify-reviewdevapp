...
import ReviewListPage from "../routes/reviewList";
import QuestionAnswerPage from "../routes/question&AnswerList";
    ...
    createRoutesFromElements(
      <Route path="/" element={<Layout />}>
        ...
        <Route path="/dashboard" element={<DashboardPage />} />
         ...
         <Route path="/question&AnswerList" element={<QuestionAnswerPage />} />
  ...
  return (
    <>
      ...
      <NavMenu>
        ...
        <Link to="/question&AnswerList">Question&AnswerList</Link>
      </NavMenu>
    </>
  );
}
